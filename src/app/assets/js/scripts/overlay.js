...
function setOverlayCodeBlockContent(title, description, block, acknowledge, dismiss = 'Dismiss'){
    document.getElementById('overlayCodeTitle').innerHTML = title
    document.getElementById('overlayCodeDesc').innerHTML = description
    document.getElementById('overlayCodeBlockCode').innerHTML = block
    document.getElementById('overlayCodeAcknowledge').innerHTML = acknowledge
    document.getElementById('overlayCodeDismiss').innerHTML = dismiss
}
